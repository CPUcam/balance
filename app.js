...
app.get('/debt', passportConfig.isAuthenticated, debtController.getDebt);
app.post('/debt', passportConfig.isAuthenticated, debtController.postSearchFriend);
app.post('/debt/add', passportConfig.isAuthenticated, debtController.postAddFriend);
